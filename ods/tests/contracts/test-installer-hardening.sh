...
assert_contains "$win_installer" "Continuing Compose preflight and service launch with the user's default Docker config" "Windows Docker fallback should carry through Compose preflight and launch"
